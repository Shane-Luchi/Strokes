...
CUDA_VISIBLE_DEVICES=1 python evaluate_docvqatest_qwen.py 

CUDA_VISIBLE_DEVICES=4 nohup python evaluate_docvqatest_qwen.py  > evaluate_docvqatest_qwen_523.log 2>&1 &
...
def evaluate_docvqa_performance():
    ...
    results_filename = f"docvqa_{DOCVQA_SPLIT}_predictions.json"
    ...
    output_file_path = "logs/docvqa_results_logs"
    output_file_path = os.path.join(output_file_path, results_filename)
