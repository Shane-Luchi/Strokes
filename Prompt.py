    ...
    messages = [
        {
            ...
            "content": [
                ...
                {"type": "text", "text": "请你用中文描述图片中汉字的笔画顺序，直接给出笔画顺序，从下面五种笔画的范围内选取：横、竖、撇、捺、横折钩。每个笔画之间用空格空开，不要采用顿号，逗号等其他符号。"}
            ]
        }
    ]
...
def predict_clip_gpt2(image_path):
    ...
    outputs = gpt2_model.generate(input_ids, max_length=64, do_sample=True, temperature=0.9)
